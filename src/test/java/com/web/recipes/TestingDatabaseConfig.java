...
public class TestingDatabaseConfig {
    ...
    private static final String DB_NAME =
            Objects.requireNonNullElse(System.getenv("DB_NAME"), "Recipes");
    ...
    public DataSource dataSource() throws SQLException {
        ...
        ScriptUtils.executeSqlScript(dataSource.getConnection(), new FileSystemResource("database/recipesSchema.sql"));
